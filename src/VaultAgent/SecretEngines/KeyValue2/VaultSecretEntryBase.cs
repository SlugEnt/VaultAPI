...
namespace VaultAgent.SecretEngines
{
    ...
    /// </summary>
    public abstract class VaultSecretEntryBase : IKV2Secret
    { //: KV2SecretBase<VaultSecretEntryNoCAS> {
        ...
        /// Constructor
        /// </summary>
        public VaultSecretEntryBase() { InitializeNew(); }
        ...
        public VaultSecretEntryBase(string name, string path = "") { InitializeNew(name, path); }
    ...
    #region "Attribute Accessor Methods"
        ...
        /// <summary>
        /// Stores a boolean string value as a string with T for True and F for False.  Valid values are "true" for True. Everything else is false.
        /// </summary>
        /// <param name="attributeName">The name of the attribute to set</param>
        /// <param name="value">The boolean value to set the attribute to</param>
        protected internal void SetBoolAttribute(string attributeName, string value)
        {
            if (value == "true")
                _secret.Attributes[attributeName] = "T";
            else
        ...
        protected internal void SetIntAttribute(string attributeName, int value) { _secret.Attributes[attributeName] = value.ToString(); }
        ...
        /// <param name="attributeName">Name of the Attribute to save the value under</param>
        /// <param name="value">The value to be stored</param>
        protected internal void SetShortAttribute(string attributeName, short value) { _secret.Attributes[attributeName] = value.ToString(); }
        ...
        /// </summary>
        /// <returns></returns>
        public string GetParentPath() { return ((IKV2Secret)_secret).GetParentPath(); }
