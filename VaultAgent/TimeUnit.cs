...
namespace CommonFunctions
{
	...
	///      
	/// Two TimeUnits are considered to be equal if there base amount of time (seconds) is the same.  So a TimeUnit of 120s and 2m would be considered equal.  This applies
