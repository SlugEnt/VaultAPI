...
namespace VaultAgent
{
	...
	public enum EnumVaultExceptionCodes {
		UnclassifiedError = 0,				// The default value for all VaultExceptions.  Indicates we have not classified the error any more specifically than what Vault provided.
