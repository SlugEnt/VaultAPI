...
namespace VaultAgent.Backends.System {
    public class AuthMethod {
        ...
        public AuthMethod (string path, EnumAuthMethods authenticationMethod) {
            ...
            if ( path == null ) { throw new ArgumentException ("The path value cannot be null."); }

            if ( path == "" ) { throw new ArgumentException ("The path value cannot be an empty string."); }
